						...
						<div className="icon-box1">
							<div className="icon-box1-visible flex-two">
								<div className="content">
									...
									<h3 className="title mb-47"><Link href="/service-details">UX/UI Design</Link></h3>
									<div className="icon">
							...
							<div className="icon-box1-hide">
								...
								<h3 className="title"><Link href="/service-details">UX/UI Design</Link></h3>
						...
						<div className="icon-box1">
							<div className="icon-box1-visible flex-two">
								<div className="content">
									...
									<h3 className="title mb-47"><Link href="/service-details">IT Management</Link></h3>
									<div className="icon">
							...
							<div className="icon-box1-hide">
								...
								<h3 className="title"><Link href="/service-details">IT Management</Link></h3>
								<p className="des">Sed ut perspiciatis unde omnis iste natus voluptatem accusantium
									laudantium</p>
								<div className="button-icon-box">
									<Link href="/service-details" className="service-link">Read More<i className="icon-right-icon" /></Link>
						...
						<div className="icon-box1">
							<div className="icon-box1-visible flex-two">
								<div className="content">
									...
									<h3 className="title mb-47"><Link href="/service-details">Data Security</Link></h3>
									<div className="icon">
							...
							<div className="icon-box1-hide">
								...
								<h3 className="title"><Link href="/service-details">Data Security</Link></h3>
								<p className="des">Sed ut perspiciatis unde omnis iste natus voluptatem accusantium
									laudantium</p>
								<div className="button-icon-box">
									<Link href="/service-details" className="service-link">Read More<i className="icon-right-icon" /></Link>
						...
						<div className="icon-box1">
							<div className="icon-box1-visible flex-two">
								<div className="content">
									...
									<h3 className="title mb-47"><Link href="/service-details">Infrastructure Plan </Link></h3>
									<div className="icon">
							...
							<div className="icon-box1-hide">
								...
								<h3 className="title"><Link href="/service-details">Infrastructure Plan</Link></h3>
								<p className="des">Sed ut perspiciatis unde omnis iste natus voluptatem accusantium
									laudantium</p>
								<div className="button-icon-box">
									<Link href="/service-details" className="service-link">Read More<i className="icon-right-icon" /></Link>
						...
						<div className="icon-box1">
							<div className="icon-box1-visible flex-two">
								<div className="content">
									...
									<h3 className="title mb-47"><Link href="/service-details">Firewall Advancement </Link></h3>
									<div className="icon">
							...
							<div className="icon-box1-hide">
								...
								<h3 className="title"><Link href="/service-details">Firewall Advancement</Link></h3>
								<p className="des">Sed ut perspiciatis unde omnis iste natus voluptatem accusantium
									laudantium</p>
								<div className="button-icon-box">
									<Link href="/service-details" className="service-link">Read More<i className="icon-right-icon" /></Link>
						...
						<div className="icon-box1">
							<div className="icon-box1-visible flex-two">
								<div className="content">
									...
									<h3 className="title mb-47"><Link href="/service-details">Desktop Computing</Link></h3>
									<div className="icon">
							...
							<div className="icon-box1-hide">
								...
								<h3 className="title"><Link href="/service-details">Desktop Computing</Link></h3>
								<p className="des">Sed ut perspiciatis unde omnis iste natus voluptatem accusantium
									laudantium</p>
								<div className="button-icon-box">
									<Link href="/service-details" className="service-link">Read More<i className="icon-right-icon" /></Link>
